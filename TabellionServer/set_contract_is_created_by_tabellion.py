...
print("Going to update contract with id: " + sys.argv[1] + "'s is_created_by_tabellion to " + sys.argv[2])

sql = "UPDATE contracts SET is_created_by_tabellion = '"+ sys.argv[2] +"' WHERE contractid = '" + sys.argv[1] + "'"
mycursor.execute(sql)
