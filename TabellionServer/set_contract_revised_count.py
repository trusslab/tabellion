...
print("Going to update contract with id: " + sys.argv[1] + "'s revised_num_count to " + sys.argv[2])

sql = "UPDATE contracts SET revised_num_count = '"+ sys.argv[2] +"' WHERE contractid = '" + sys.argv[1] + "'"
mycursor.execute(sql)
