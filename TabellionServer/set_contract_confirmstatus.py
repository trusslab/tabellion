...
print("Going to update contract with id: " + sys.argv[1] + "'s confirmstatus to " + sys.argv[2])

sql = "UPDATE contracts SET confirmstatus = '" + sys.argv[2] + "' WHERE contractid = '" + sys.argv[1] + "'"
mycursor.execute(sql)
